...
class Bitrix24{
    ...
    public function __construct($title = "", $phone = "", $comment = "", $email = "", $action = ""){
      ...
      $this->utm_source = $_SESSION['utm_source'] ? $_SESSION['utm_source'] : "";
      $this->utm_medium = $_SESSION['utm_medium'] ? $_SESSION['utm_medium'] : "";
      $this->utm_campaign = $_SESSION['utm_campaign'] ? $_SESSION['utm_campaign'] : "";
      $this->utm_content = $_SESSION['utm_content'] ? $_SESSION['utm_content'] : "";
      $this->utm_term = $_SESSION['utm_term'] ? $_SESSION['utm_term'] : "";
