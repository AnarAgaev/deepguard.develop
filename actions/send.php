...
if($utm_source != ""){
    $message_crm .="utm_source: {$utm_source}\n";
}
if($utm_medium != ""){
    $message_crm .="utm_medium: {$utm_medium}\n";
}
if($utm_campaign != ""){
    $message_crm .="utm_campaign: {$utm_campaign}\n";
}
if($utm_content != ""){
    $message_crm .="utm_content: {$utm_content}\n";
}
if($utm_term != ""){
    $message_crm .="utm_term: {$utm_term}\n";
}
